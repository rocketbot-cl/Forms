...
Conéctese y trabaje con Rocketbot Forms Xperience  
...
Obtener datos de formulario de la cola. Debe tener tantas variables como 'inputs' tenga el formulario, las mismas deben llamarse como el 'Element ID' del 'input'.
|Parámetros|Descripción|ejemplo|
| --- | --- | --- |
